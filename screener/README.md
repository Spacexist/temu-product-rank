...
```text
output/915_scored.csv
output/915_分享.html
output/915_Top5pct_去违禁_去2D平面.csv
```

915 使用 909-914 增量训练模型预测；Top500 自动过滤后保留 284 条，过滤后违禁命中 0，2D/平面命中 0。

## 916 当前结果

```text
output/916_scored.csv
output/916_分享.html
output/916_Top5pct_去违禁_去2D平面.csv
```
