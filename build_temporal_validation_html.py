...
METRICS = ART / "temporal_metrics.json"
OUT = ART / "时间外推验证报告.html"
...
<head>
  ...
  <title>时间外推验证 — 909+910 → 911</title>
  <style>
    :root {{
      --bg: #0f1419;
      --surface: #1a2332;
  ...
  <div class="wrap">
    <div class="grid">
      ...
      <div class="kpi">
        ...
        <p class="s">911 基线 {pct(main['bases']['gt0'])}</p>
      </div>
      <div class="kpi">
        <div class="t">911 test（清洗后）</div>
    ...
    <div class="alert">
      <strong>铁律：</strong>911 动销基线（{pct(main['bases']['gt0'])}）高于混合 test，<strong>禁止只看绝对 P(&gt;0)</strong>。
