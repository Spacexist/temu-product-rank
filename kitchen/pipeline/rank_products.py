...
# 向量/ASCII 模型默认写到无中文的 Local 目录，避免覆盖 D:\temu_rank_npz，也避免 LGBM save_model 踩中文路径。
_ASCII = Path(os.environ.get("KITCHEN_ASCII", r"C:\Users\ZFGJ-WCH\AppData\Local\kitchen_rank"))
